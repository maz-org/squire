...
const TRACE_FIELD_DEFINITIONS = [
  ...
  },
  {
    ...
    debugCategory: 'filter',
    includeInAppConversationHistory: false,
    description: 'Eval case identifier from eval/suites fixtures.',
  },
  {
    name: 'game',
    required: true,
    ...
    debugCategory: 'filter',
    includeInAppConversationHistory: false,
    description: 'Canonical game id used by the eval case.',
  },
  {
    name: 'suite',
    required: true,
    ...
    debugCategory: 'filter',
    includeInAppConversationHistory: false,
    description: 'Eval suite name used for LangSmith grouping.',
  },
  {
    name: 'caseCategory',
    required: true,
