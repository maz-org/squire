...
describe('eval scoring summaries', () => {
  ...
  it('accepts bare GH2e naming in cross-game boundary answers', async () => {
    const scores = await traceScoresForEvalResult({} as never, {
      evalCase: {
        id: 'boundary-scenario-61-fh-then-gh2',
        game: 'gloomhaven-2e',
      ...
      answer:
        'No. Frosthaven scenario 61 is Life and Death, while GH2e scenario 61 is Dangerous Grove. They are distinct game-qualified scenarios.',
      toolCalls: [
        {
          iteration: 1,
          id: 'call_1',
