...
### Phase 2: Gloomhaven (2nd Edition) content expansion
...
- **2026-04-07 (v2.0):** Major refresh after the first month of real building.
  ...
  - **Stack updates:** Hono JSX + HTMX + Tailwind (in-process dev compile + prebuilt production assets; no React, no Next.js). Drizzle (no Prisma). pgvector (no Pinecone). Custom Google OAuth (no NextAuth / Clerk). Sonnet 4.6. Voyage AI embeddings. Edge WAF as a Phase 1 deployment requirement.
