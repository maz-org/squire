...
| -------------------------- | -------------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CI actionlint              | `CI` on PRs to `main`, pushes to `main`, and manual dispatch   | Maintainers | Fails the `CI` check when workflow syntax or action rules fail                                           | GitHub check failure only; not mirrored to Linear                                                                                                          |
