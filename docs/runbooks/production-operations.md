...
Sentry-side scrubbing setup lives in
[sentry-scrubbing.md](sentry-scrubbing.md). The current project must keep
default data scrubbing enabled, prevent storing IP addresses, and install the
Advanced Data Scrubbing config generated by
