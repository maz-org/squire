...
This is the repo copy of the Gloomhaven 2.0 contract. The Linear document is
...
| Gloomhaven 2.0 / Gloomhaven Second Edition | `gloomhaven-2e` | Canonical internal id for Phase 2. |
...
| Source metadata preserves game, source type, source URL, capture timestamp, and refresh notes.                                  | GH2 rulebook/FAQ/errata/GHS records expose the metadata through source inspection or stored records.                                                  | GH2 Rules, FAQ, and Errata Corpus; GH2 GHS Structured Data Import                                      |
...
| UI shows `Gloomhaven 2.0` and hides internal ids.                                                                               | Game selector/runtime UI uses user-facing copy only.                                                                                                  | Active Game UX and Runtime Routing                                                                     |
